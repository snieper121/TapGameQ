...
#define PACKAGE_NAME "com.example.mytapgameserver"
#define SERVER_NAME "tapgame_server"
#define SERVER_CLASS_PATH "com.example.mytapgameserver.server.MyPersistentServer"
